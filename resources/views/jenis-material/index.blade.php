...
@section('title', __('Jenis Materials'))
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h3>{{ __('Jenis Materials') }}</h3>
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of all jenis materials.') }}
                    </p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="/">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Jenis Materials') }}</li>
                </x-breadcrumb>
            </div>
        </div>
