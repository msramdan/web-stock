        ...
        <div class="page-title">
            <div class="row">
                ...
                <x-breadcrumb>
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('transaksi-stock-in.index') }}">{{ __('Transaksis') }}</a>
                    </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ isset($transaksi->tanggal) ? $transaksi->tanggal?->format('Y-m-d H:i:s') : '' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            @if (!$transaksi->attachment)
                                                <img src="https://via.placeholder.com/350?text=No+Image+Avaiable"
                                                    alt="Attachment" class="rounded img-fluid">
                                            @else
                                                <img src="{{ asset('storage/uploads/attachments/' . $transaksi->attachment) }}"
                                                    alt="Attachment" class="rounded img-fluid">
                                            @endif
                                        </td>
                                    </tr>
